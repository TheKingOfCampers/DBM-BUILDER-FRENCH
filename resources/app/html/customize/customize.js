...
Editado por: 
*/
const configFile = "./config_customizev07.json",
...
tabbgset = document.getElementsByClassName("tabbg")[0],
tabbghover = document.getElementById('tabbghover'),
tabbghoverset = document.getElementsByClassName("tabbghover")[0],
tabborder = document.getElementById('tabborder'),
tabborderset = document.getElementsByClassName("tabborder")[0],
tabbgtop = document.getElementById('tabbgtop'),
tabbgtopset = document.getElementsByClassName("tabbgtop")[0],
tabbgtopativo = document.getElementById('tabbgtopativo'),
tabbgtopativoset = document.getElementsByClassName("tabbgtopativo")[0],

/* Efeito */ 
efeitoinicial = document.getElementById('efeitoinicial'),
efeitoinicialset = document.getElementsByClassName("efeitoinicial")[0],
...
customizej1set = document.getElementsByClassName("customizej1")[0],
customizej2 = document.getElementById('customizej2'),
customizej2set = document.getElementsByClassName("customizej2")[0],
customizej3 = document.getElementById('customizej3'),
customizej3set = document.getElementsByClassName("customizej3")[0],
customizej4 = document.getElementById('customizej4'),
customizej4set = document.getElementsByClassName("customizej4")[0],
customizej5 = document.getElementById('customizej5'),
customizej5set = document.getElementsByClassName("customizej5")[0],
customizej6 = document.getElementById('customizej6'),
customizej6set = document.getElementsByClassName("customizej6")[0],
customizej7 = document.getElementById('customizej7'),
customizej7set = document.getElementsByClassName("customizej7")[0],
...
customizebotaotextohset = document.getElementsByClassName("customizebotaotextoh")[0],
customizebotaoh = document.getElementById('customizebotaoh'),
customizebotaohset = document.getElementsByClassName("customizebotaoh")[0],
		...
		if (notasgat.checked == true) {
		  ...
		  if (msavegat.checked == true) {
			...
			document.querySelector("[name='msavegat2']").style.display = "block";
											...
											/* TAB */ 
											tabbg.value = tabbgset.style.background = config.tabbg !== undefined ? config.tabbg : "rgba(30,30,30,0.7)";
											document.documentElement.style.setProperty("--config-tabbg", document.getElementById("tabbg").value);
											tabbghover.value = tabbghoverset.style.background = config.tabbghover !== undefined ? config.tabbghover : "rgba(40,60,60,0.7)";
											document.documentElement.style.setProperty("--config-tabbghover", document.getElementById("tabbghover").value);
											tabborder.value = tabborderset.style.background = config.tabborder !== undefined ? config.tabborder : "rgba(60,60,60,0.7)";
											document.documentElement.style.setProperty("--config-tabborder", document.getElementById("tabborder").value);
											tabbgtop.value = tabbgtopset.style.background = config.tabbgtop !== undefined ? config.tabbgtop : "rgba(20,20,20,0.7)";
											document.documentElement.style.setProperty("--config-tabbgtop", document.getElementById("tabbgtop").value);
											tabbgtopativo.value = tabbgtopativoset.style.background = config.tabbgtopativo !== undefined ? config.tabbgtopativo : "rgba(0,0,0,0.7)";
											document.documentElement.style.setProperty("--config-tabbgtopativo", document.getElementById("tabbgtopativo").value);

								/* Efeito */ 
								efeitoinicial.value = efeitoinicialset.value = config.efeitoinicial !== undefined ? config.efeitoinicial : "jiggle";
...
document.documentElement.style.setProperty("--config-customizej7", document.getElementById("customizej7").value);
												...
												customizebotaotextoh.value = customizebotaotextohset.style.background = config.customizebotaotextoh;
												...
												customizebotaoh.value = customizebotaohset.style.background = config.customizebotaoh;
...
/* Actions & Eventos  */ 
		...
		/* Janela de Actions  */ 
		customizej1.value = "#111";
		customizej2.value = "#C8C8C8";
		customizej3.value = "#222";
		customizej4.value = "#222";
